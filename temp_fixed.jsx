    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40">
        <div className="relative flex flex-col items-center gap-4">
          ...
          <p className="text-sm font-medium text-slate-600">Loading partner services...</p>
        </div>
      </div>
    );
  }
            ...
            {isPendingProvider ? (
              <>
                <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-amber-100">
                  ...
                  <p className="mb-2 text-lg font-semibold text-amber-700">Partner Profile Pending Approval</p>
              </>
            ) : (
              <>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-6 pt-6 sm:px-6 lg:px-8 sm:pb-6">
          ...
          <div className="relative mx-auto max-w-5xl">
            ...
            >
              ...
              <motion.div
                ...
                className="mb-6 overflow-hidden rounded-[32px] border border-white/70 bg-[radial-gradient(circle_at_top_right,rgba(191,219,254,0.35),transparent_32%),linear-gradient(135deg,rgba(255,255,255,0.98),rgba(248,250,252,0.96)_55%,rgba(239,246,255,0.98))] shadow-xl shadow-slate-200/20 backdrop-blur-2xl"
              >
                  ...
                  <div className="p-5 sm:p-6">
                    <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
                      <div className="relative mx-auto sm:mx-0">
                        {provider?.avatar ? (
                           <img
                             ...
                             className="h-28 w-28 rounded-3xl border-4 border-white/50 object-cover shadow-xl sm:h-32 sm:w-32"
                           />
                        ) : (
                          <div
                            className={`flex h-28 w-28 items-center justify-center rounded-3xl border-4 border-white/50 bg-gradient-to-br ${getProviderColor(providerName)} text-5xl font-bold text-white shadow-xl sm:h-32 sm:w-32`}
                          >
                      ...
                      <div className="min-w-0 flex-1 text-center sm:text-left">
                        ...
                        <p className="mt-1 text-sm font-medium text-slate-600 sm:text-base">{providerCategoryLabel}</p>
                    ...
                    <div className="mt-5 grid gap-3 sm:grid-cols-3">
                      <div className="rounded-2xl border border-slate-200 bg-white/75 p-4 text-left shadow-sm">
                        <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">Service Focus</p>
                        <p className="mt-2 text-sm font-bold text-slate-900">{providerCategoryLabel}</p>
                        <p className="mt-1 text-xs leading-5 text-slate-500">Primary category currently highlighted for this listing</p>
                      </div>
                      <div className="rounded-2xl border border-slate-200 bg-white/75 p-4 text-left shadow-sm">
                        <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">Booking Access</p>
                        <p className="mt-2 text-sm font-bold text-slate-900">
                          {canShowPrices ? "Pricing unlocked" : "Login required"}
                        </p>
                        <p className="mt-1 text-xs leading-5 text-slate-500">
                          {canShowPrices ? "Compare prices, shortlist services, and book instantly" : "Sign in as a client to view pricing and continue"}
                        </p>
                      </div>
                      <div className="rounded-2xl border border-slate-200 bg-white/75 p-4 text-left shadow-sm">
                        <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">Service Area</p>
                        <p className="mt-2 text-sm font-bold text-slate-900">{provider?.address || "Shared after inquiry"}</p>
                        <p className="mt-1 text-xs leading-5 text-slate-500">Helpful for planning venue access and event logistics</p>
                      </div>
                    </div>
                  </div>

                  <div className="border-t border-slate-200/70 bg-[linear-gradient(180deg,rgba(248,250,252,0.98),rgba(239,246,255,0.95))] p-5 sm:p-6 lg:border-l lg:border-t-0">
                    <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
                      <div className="rounded-2xl border border-amber-100 bg-gradient-to-br from-amber-50 to-orange-50 p-3.5 text-left shadow-sm">
                        <div className="flex items-center gap-3">
                          <div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 shadow-md">
                            <Star className="h-4 w-4 text-white" />
                          </div>
                          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-amber-700">Client Rating</p>
                        </div>
                        <p className="mt-3 text-2xl font-display font-black text-slate-900">
                        ...
                        <p className="mt-1 text-xs text-slate-500">
                          {providerRatingCount > 0
                            ...
                            : "Fresh listing on the platform"}
                        </p>
                      </div>
                      <div className="rounded-2xl border border-cyan-100 bg-gradient-to-br from-cyan-50 to-blue-50 p-3.5 text-left shadow-sm">
                        <div className="flex items-center gap-3">
                          <div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 shadow-md">
                            <Shield className="h-4 w-4 text-white" />
                          </div>
                          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-cyan-700">Category Focus</p>
                        </div>
                        <p className="mt-3 text-sm font-bold text-slate-900">{providerCategoryLabel}</p>
                        <p className="mt-1 text-xs text-slate-500">Aligned with this partner's active service listings</p>
                      </div>
                      <div className="rounded-2xl border border-emerald-100 bg-gradient-to-br from-emerald-50 to-teal-50 p-3.5 text-left shadow-sm">
                        <div className="flex items-center gap-3">
                          <div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 shadow-md">
                            <MapPin className="h-4 w-4 text-white" />
                          </div>
                          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-emerald-700">Availability Area</p>
                        </div>
                        <p className="mt-3 text-sm font-bold text-slate-900">{provider?.address || "Location shared after inquiry"}</p>
                        <p className="mt-1 text-xs text-slate-500">Useful for planning logistics and service reach</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="relative px-2 pt-2 pb-8 sm:px-6 sm:pt-3 sm:pb-10 md:pt-4 md:pb-12">
          {/* Background Pattern */}
          ...
          <div className="relative mx-auto max-w-6xl">
            ...
            >
              ...
              <p className="text-base text-slate-600 max-w-2xl mx-auto leading-relaxed">
                Explore this partner&apos;s service like a product detail page, review recent work photos, and book with full context.
              </p>
            </motion.div>
              ...
              <>
                ...
                >
                  <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg">
                    {displayServiceImages.length > 0 ? (
                      <div className="relative overflow-hidden">
                        ...
                        {displayServiceImages.length > 1 ? (
                          <div className="absolute left-3 top-3 z-10 hidden sm:block sm:w-[92px]">
                            <div className="flex max-w-full gap-2 overflow-x-auto p-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden sm:max-h-[420px] sm:flex-col sm:overflow-x-hidden sm:overflow-y-auto">
                    ...
                    {displayServiceImages.length > 1 ? (
                      <div className="border-t border-slate-200 bg-slate-50/70 p-3 sm:hidden">
                        <div className="flex gap-2 overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                          {displayServiceImages.map((image, imageIndex) => (
                            <button
                              key={`${displayService._id}-mobile-${imageIndex}`}
                              type="button"
                              onClick={() => setActiveImageIndex(imageIndex)}
                      ...
                      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
                        <div className="space-y-5">
                          ...
                          <div className="space-y-3">
                            <h3 className="font-display text-3xl font-black leading-tight tracking-[-0.03em] text-slate-950 sm:text-4xl">
                          ...
                          <div className="flex flex-wrap gap-2">
                            <span className="inline-flex items-center rounded-full border border-blue-100 bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-700">
                              ...
                              Real gallery included
                            </span>
                            <span className="inline-flex items-center rounded-full border border-violet-100 bg-violet-50 px-3 py-1.5 text-xs font-semibold text-violet-700">
                            ...
                            <span className="inline-flex items-center rounded-full border border-amber-100 bg-amber-50 px-3 py-1.5 text-xs font-semibold text-amber-700">
                              ...
                              {displayService.allowsMembers ? "Guest-based pricing available" : "Fixed package pricing"}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="space-y-5">
                          ...
                          {canShowPrices && currentCart.length > 0 ? (
                            <div className="rounded-3xl border border-primary-100 bg-gradient-to-br from-primary-50 via-white to-blue-50 p-4 shadow-lg shadow-primary-100/40 sm:p-5">
      ...
      {showBookingModal ? (
        <div className="fixed inset-0 z-[999] flex items-start justify-center overflow-y-auto overscroll-contain bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.95),rgba(241,245,249,0.9)_45%,rgba(226,232,240,0.84)_100%)] p-3 pt-4 pb-24 backdrop-blur-md sm:items-center sm:p-5">
          <motion.div
            ...
            className="flex max-h-[92vh] w-full max-w-4xl flex-col overflow-hidden rounded-[32px] border border-white/80 bg-white/95 shadow-[0_24px_70px_rgba(148,163,184,0.24)]"
          >
            <div className="sticky top-0 z-10 rounded-t-[32px] border-b border-slate-100 bg-gradient-to-r from-slate-950 via-primary-900 to-blue-900 px-5 py-5 text-white sm:px-7">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div className="flex items-start justify-between gap-4 lg:block">
                  ...
                  <button
                    ...
                    className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-white/15 bg-white/10 text-white transition hover:bg-white/20 lg:hidden"
                  >
                    <X className="h-5 w-5" />
                  </button>
                </div>
            ...
            <div className="grid flex-1 gap-6 overflow-y-auto p-5 sm:p-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:p-7">
              <div className="space-y-5">
                <div className="rounded-3xl border border-slate-200 bg-slate-50/80 p-4 shadow-sm">
                  <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-500">Event Details</p>
                  <p className="mt-2 text-sm text-slate-600">
                    Share the core event details below so your booking request is reviewed with the right context.
                  </p>
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-base text-slate-900 outline-none transition focus:border-primary-400 focus:bg-white focus:ring-4 focus:ring-primary-100 sm:text-sm"
                  />
                  </div>
                ...
                {bookingHasMemberPricing ? (
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-amber-200 bg-white px-4 py-3 text-base text-slate-900 outline-none transition focus:border-amber-400 focus:ring-4 focus:ring-amber-100 sm:text-sm"
                  />
              ...
              <div className="rounded-3xl border border-slate-200 bg-slate-50/80 p-5 lg:sticky lg:top-4 lg:self-start">
            ...
            <div className="sticky bottom-0 flex flex-col gap-3 border-t border-slate-200 bg-slate-50/95 px-5 py-4 backdrop-blur-xl sm:flex-row sm:px-7">
              <Button
                variant="secondary"
                onClick={() => setShowBookingModal(false)}
